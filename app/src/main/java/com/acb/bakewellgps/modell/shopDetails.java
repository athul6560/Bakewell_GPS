...
public class shopDetails {
    ...
    public String province_area_name;
    ...
    public String getProvince_area_name() {
        return province_area_name;
    }

    public void setProvince_area_name(String province_area_name) {
        this.province_area_name = province_area_name;
    }
    ...
    public void setShop_contact_name(String shop_contact_name) {
        this.shop_contact_name = shop_contact_name;
    }

    public String getShop_contact_mobile_no() {
        return shop_contact_mobile_no;
    }

    public void setShop_contact_mobile_no(String shop_contact_mobile_no) {
        this.shop_contact_mobile_no = shop_contact_mobile_no;
    }

    public String getShop_contact_email_id() {
        return shop_contact_email_id;
    }

    public void setShop_contact_email_id(String shop_contact_email_id) {
    ...
    public int getTl_expiry_date() {
        return tl_expiry_date;
    }

    public void setTl_expiry_date(int tl_expiry_date) {
