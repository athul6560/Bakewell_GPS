...
public class ShopViewActivity extends AppCompatActivity {
    ...
    private void setTextAddress(Address address) {
        binding.longitude.setText(address.getFeatureName() + "\n" + "Pin: " + address.getPostalCode() + ", " + address.getCountryName() + address.getLocality());
        binding.langitude.setText(address.getLatitude() + "," + address.getLongitude());
    }
